...
namespace OverOverload
{
    class Execution
    {
        ...
        static public void MenuOfMatrices()
        {
            ...
            Console.WriteLine("2 - 1ая матрица");
            Console.WriteLine("3 - 2ая матрица");
            int choice = 0;
            ...
            {
                throw new Exception("Операция некорректна");
            }
            string operation;
            int component;
            switch (choice)
            {
                case 1:
                    if (PrintMatrix())
                    {
                        Console.WriteLine("Выберите операцию: '+' или '*' или '?'");
        ...
        static public int DisplayMenu()
        {
            ...
            Console.WriteLine("2: Доступные операции с матрицами");
