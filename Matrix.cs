    ...
    class SquareMatrix : ICloneable
    {
        ...
        public SquareMatrix(int sizeOfMatrix)
        {
            try
            {
                if (sizeOfMatrix <= 0)
                {
                    throw new MatrixException("Размерность введена некорректно");
                }
        ...
        public override bool Equals(object obj)
        {
            try
            {
                ...
                {
                    throw new ObjectException("Сравненить невозможно");
                }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (sqMatrix == null)
            {
                throw new ArgumentException("Один из элементов матрицы таковым не является");
            }
            else
            {
        ...
        public int Determinant()
        {
            ...
            if (sqMatrix == null)
            {
                throw new MatrixException("Ошибка - Матрица не определена");
            }
            int result = toggle;
